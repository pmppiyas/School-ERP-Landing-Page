...
const Logo = ({ className = '', variant = 'auto', onClick }: LogoProps) => {
  const textClass =
    variant === 'light'
      ? 'text-white'
      : variant === 'dark'
  ...
  return (
    ...
    >
      {/* Icon Badge */}
      <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-violet-600 text-white shadow-md shadow-blue-500/25 ring-1 ring-white/20 group-hover:scale-105 transition-all">
